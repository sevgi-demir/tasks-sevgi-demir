 ...
 * @author sevgidemir
 */
public class Pegasus extends HavaYoluSirketleri implements IAvantajlar{
        ...
        public void yemekServisi() {
            System.out.println("Yurt içi uçuşlarımızda yemek servislerimiz mevcuttur.");
        }

        @Override
        public String SirketAdi() {
        return sirketAdi="Pegasus";
    }

        @Override
        public double EkonomiUcret() {
        return ekonomiUcret=650;
    }
